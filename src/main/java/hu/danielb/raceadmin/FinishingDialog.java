...
import hu.danielb.raceadmin.listeners.FinishingListener;
...
public class FinishingDialog extends BaseDialog {
    ...
    HashMap<Integer, Integer> positionBoy;
    HashMap<Integer, Integer> positionGirl;
    HashMap<Integer, Contestant> contestants;
    HashMap<Integer, AgeGroup> ageGroups;
    HashMap<Integer, School> schools;
