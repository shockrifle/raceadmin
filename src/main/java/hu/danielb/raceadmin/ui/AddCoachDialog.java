...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void refreshSchools() {
        mComboBoxSchools.setModel(new DefaultComboBoxModel<>(new School[]{new School(0, "")}));
        try {
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(mComboBoxSchools, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(350, -1), new Dimension(350, -1), new Dimension(350, -1), 0, false));
