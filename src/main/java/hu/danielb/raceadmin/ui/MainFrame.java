...
//      hogy ötből a négy jobb eredménye számít a csapatversenybe.Érmet az ötödik tanuló is kap, de eredménye nem számít a csapatversenybe.
//      Ha csak négyen indulnak, mindenkinek végig kell menni a pályán, és a végelszámolásnál mindegyikük eredménye beleszámít a csapatversenybe.
//  4.Ahogy telefonon is beszéltünk erről,ez a kérdés az elmúlt tíz évben nem vetődött fel,és ahogy ígértem,utána fogok nézni.
//      Ugyanakkor ez a kérdés akkor vet fel problémát,hogy ha történetesen az adott intézmény kilenc vagy tíz főt nevez a versenyre.
//      Nyolc fő nevezése esetén két négy fős csapat van,és a kérdés itt nem kérdés azért,mert...de...vagy van két négyfős csapatom,
//      vagy van egy ötfős csapatom,és még van három tanuló,akik nem értek el semmit,azon kívül,hogy lefutották a távot.De mi van,
//      ha testnevelő az ötödiknek is akar adott esetben érmet adni,akkor feláldozza a második csapatát?Kilenc vagy tíz fő esetében szerintem
//      automatikusan az első csapatot egészítem ki öt főre,ha érmet nyertek....de...ha a második csapat is éremszerző helyen ért célba,
//      akkor hová teszem az ötödik embert.
...
//  2.Egyenlő csapat-pontszám esetén azt a csapatot soroljuk előrébb,akinek a negyedik versenyzője jobb helyezést ért el,mint a holtversenyben lévő
//      másik csapat negyedik versenyzője.Az ötödiknek célba érkező versenyző helyezési pontszáma nem számít,mivel eleve négy fős a csapatverseny.
...
//TODO: i18n
//TODO: export után fájl megnyitása
//ALERT: 5.Szerintem az internetes oldalhoz van lehetőség hozzá férni akkor,ha a hozzáféréshez jogosítvánnyal rendelkező hat fő közül valaki oda
//  adja neked a saját hozzáférési kódját.A dolog nem lehetetlen,mivel Őze Lászlónak van hozzáférése/kódja/,
//  nekem nincs.Viszont az eredményes rendezés közös érdek,ezért van remény...szerintem jövő tavasszal a következő
//  bajnokság előtt erre a kérdésre térjünk vissza.
